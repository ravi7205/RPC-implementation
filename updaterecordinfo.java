...
public class updaterecordinfo extends JFrame
{
	JButton enter;
	...
	public updaterecordinfo(Client client, String st1, ArrayList<JLabel> label,int col,int[] dType,ArrayList<String> header)
	{
		...
		enter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e){
				...
				try
				{
					...
					new updatecondition(client,st1,label,col,dType,header,cmd);
					dispose();
