...
// Code for getting information about columns of table which we want to create
...
public class columnsinfo extends JFrame
{
	JButton enter;
	...
	public columnsinfo(Client client, String name,int col)
	{
		...
		l1=new JLabel("Column Name");
		l1.setBounds(110,0,100,20);
		c.add(l1);
		...
		enter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e){
				...
				try
				{
					...
					//if(line.equals("Table Created Successfully"))
					{
