...
// code for getting info about record which we want to delete
public class deleterecordinfo extends JFrame
{
	JButton enter;
	...
	public deleterecordinfo(Client client, String st1, ArrayList<JLabel> label,int col,int[] dType,ArrayList<String> header)
	{
		...
		enter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e){
				...
				try
				{
					...
					String cmd="delete from "+st1+" where ";
					int cond=0;
					for(int i=0;i<col;i++)
					{	
					...
					if(line.equals("Records deleted successfully"))
					{
